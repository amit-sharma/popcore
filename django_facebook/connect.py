...
from django_facebook.utils import get_registration_backend, get_form_class, initializeRuntimeFlags
...
def connect_user(request, access_token=None, facebook_graph=None):
    ...
    try:
        need_update = initializeRuntimeFlags(user)
        if need_update:
            ...
            if facebook_settings.FACEBOOK_STORE_FRIENDS:
                ...
                facebook.get_and_store_friendlikes(user)
                facebook.get_and_store_tiestrength(user)
